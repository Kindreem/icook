...
export default {
  ...
  methods:{
      wx(){
        ...
        this.axios.get('https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx46bfe246fb596974&secret=ecf3b8b5219b4a264eb33634af6e6c15').then(res=>{
            console.log(res)
        }).catch(err=>{
            console.log(err)        
        })
